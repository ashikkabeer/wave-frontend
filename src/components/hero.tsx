  ...
  return (
    <div className="center h-screen w-screen hero flex flex-col align-middle justify-center items-center">
      <div className="px-10 w-screen flex flex-col align-middle justify-center items-center">
        <p className="text-4xl italic font-semibold mb-5 px-5 inline-flex animate-text-gradient bg-gradient-to-r from-[#b2a8fd] via-[#8678f9] to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-transparent">
          #LetsWave
        </p>
